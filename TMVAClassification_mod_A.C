...
void TMVAClassification_mod_A( TString myMethodList = "",  TString jet_tag_label = "jet_tag_category_label",  TCut numJet_cut = "numJets>=4", TCut numTag_cut = "numTags>=2", bool createMVA = true, TString charge = "OS", double ttbb_fraction = -1 )
{
...
//// --------inputs--------------
      ...
      TString background_name = "ttbar_bb";
...
//       } 
      ...
      std::cout << "--- TMVAClassification       : Using ttbar_bb input file: " << input2->GetName() << std::endl;
      ...
      double background_in = backgroundA_in;
      double background_pass = backgroundA_pass;
      
      if (ttbb_fraction >= 0) {
        backgroundWeightA = (1 - ttbb_fraction)*background_pass/(backgroundA_pass);
      ...
      double nTrain_pass = min(signal_pass,background_pass/backgroundWeightA)/2;
      int nTrain_signal = nTrain_pass*(signal_in/signal_pass);
      int nTrain_background = backgroundWeightA*nTrain_pass*(background_in/background_pass);
...
//    factory1->AddVariable( "first_jet_pt", 'F' );
//    factory1->AddVariable( "second_jet_pt", 'F' );
//    factory1->AddVariable( "mindr_lep1_jet", 'F' );
//    factory1->AddVariable( "sum_pt", 'F' );
//    factory1->AddVariable( "avg_btag_disc_btags", 'F' );
