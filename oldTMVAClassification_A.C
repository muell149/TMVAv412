...
void TMVAClassification_A( TString myMethodList = "",  TString jet_tag_label = "jet_tag_category_label", TString background_name = "ttbar_lf",  TCut numJet_cut = "numJets>=4", TCut numTag_cut = "numTags>=2", bool createMVA = true, TString charge = "OS", double ttbb_fraction = -1 )
{
...
//// --------inputs--------------
      ...
      TString fname1 = "inputTrees/March4/ttH125.root" ;
      TString fname2 = "inputTrees/March4/"+background_name+".root" ;
      TString fname3 = "inputTrees/March4/ttbar_cc.root" ;
      TString fname4 = "inputTrees/March4/ttbar_bb.root" ;
...
//   TString jet_tag_label = "6ormorej_3ormoret";
   ...
   TString outfileName1( "TMVA_trained_" + charge + "_" + background_name + "_" + jet_tag_label + "_simple.root" );   
...
//    factory1->AddVariable( "numJets_float", 'F' ); 
   ...
   // extra variables vs. ttbar and ttbb
...
//    factory1->AddVariable( "dijet_mass_lowest", 'F' );
//    factory1->AddVariable( "first_dibjet_mass", 'F' );
//    factory1->AddVariable( "lowest_dibjet_mass", 'F' );
...
// TMVA ANN: MLP (recommended ANN) -- all ANNs in TMVA are Multilayer Perceptrons
 ...
 if (createMVA) factory1->BookMethod( TMVA::Types::kCFMlpANN, "CFMlpANN", "!H:!V:NCycles=2000:HiddenLayers=N,N-1"  );
