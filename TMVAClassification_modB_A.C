...
void TMVAClassification_modB_A( TString myMethodList = "",  TString jet_tag_label = "jet_tag_category_label",  TCut numJet_cut = "numJets>=4", TCut numTag_cut = "numTags>=2", bool createMVA = true, TString charge = "OS", double ttbb_fraction = -1 )
{
...
//// --------inputs--------------
      ...
      TString fname1 = "output/mva_ttH125.root" ;
      TString fname2 = "output/mva_"+background_name+".root" ;
      TString fname3 = "output/mva_ttbar_cc.root" ;
...
//       } 
      ...
      double background_in = backgroundA_in+backgroundB_in;
      double background_pass = backgroundA_pass+backgroundB_pass;
      ...
      int nTrain_background = floor(backgroundWeightA*nTrain_pass*(background_in/background_pass));
...
//    factory1->AddVariable( "topLike_dijet_lep2_mass" );   
   ...
   factory1->AddVariable( "BDTG_CHARLIEge3t", 'F' );
